...
use App\Form\StepFewShotFormType;
...
#[Route('/treeflow')]
final class StepFewShotController extends AbstractController
{
    public function __construct(
        ...
        private readonly StepFewShotRepository $fewShotRepository,
    ) {}
    ...
    public function new(Request $request, string $treeflowId, string $stepId, string $questionId): Response
    {
        ...
        $fewShot = new StepFewShot();
        $fewShot->setQuestion($question);

        $form = $this->createForm(StepFewShotFormType::class, $fewShot, [
            'is_edit' => false,
        ]);
