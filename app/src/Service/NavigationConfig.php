 ...
 *
 * GENMAX INTEGRATION:
 * - Extends NavigationConfigGenerated for automatic menu item generation
 * - Merges manual items (home, student courses) with generated items
 * - Generated items come from generator_entity table via Genmax
 */
final class NavigationConfig extends NavigationConfigGenerated
{
    ...
    public function getMainMenu(): array
    {
        ...
        // ============================================
        // GENERATED ITEMS (from database via Genmax)
        // ============================================
