 ...
 * Delegates to UserRepository for all query logic.
 *
...
class UserProvider implements ProviderInterface
{
    ...
    /**
     * Provide collection of User entities
     *
     * Uses UserRepository::apiSearch() for:
     ...
     * @return array<User> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single User entity
     *
     * @param array<string, mixed> $uriVariables
     * @return User|null
     */
    private function provideItem(array $uriVariables): ?User
    {
