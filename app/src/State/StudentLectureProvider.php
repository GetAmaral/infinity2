...
/**
 * StudentLecture State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to StudentLectureRepository for all query logic.
 *
 ...
 */
class StudentLectureProvider implements ProviderInterface
{
    public function __construct(
        private readonly StudentLectureRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/studentlectures
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/studentlectures/{id}
    ...
    /**
     * Provide collection of StudentLecture entities
     *
     * Uses StudentLectureRepository::apiSearch() for:
     ...
     * @return array<StudentLecture> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single StudentLecture entity
     *
     * @param array<string, mixed> $uriVariables
     * @return StudentLecture|null
     */
    private function provideItem(array $uriVariables): ?StudentLecture
    {
