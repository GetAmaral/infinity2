...
/**
 * DealType State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to DealTypeRepository for all query logic.
 *
 ...
 */
class DealTypeProvider implements ProviderInterface
{
    public function __construct(
        private readonly DealTypeRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/dealtypes
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/dealtypes/{id}
    ...
    /**
     * Provide collection of DealType entities
     *
     * Uses DealTypeRepository::apiSearch() for:
     ...
     * @return array<DealType> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single DealType entity
     *
     * @param array<string, mixed> $uriVariables
     * @return DealType|null
     */
    private function provideItem(array $uriVariables): ?DealType
    {
