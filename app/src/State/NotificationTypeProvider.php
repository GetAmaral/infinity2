...
/**
 * NotificationType State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to NotificationTypeRepository for all query logic.
 *
 ...
 */
class NotificationTypeProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/notificationtypes
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/notificationtypes/{id}
    ...
    /**
     * Provide collection of NotificationType entities
     *
     * Uses NotificationTypeRepository::apiSearch() for:
     ...
     * @return array<NotificationType> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single NotificationType entity
     *
     * @param array<string, mixed> $uriVariables
     * @return NotificationType|null
     */
    private function provideItem(array $uriVariables): ?NotificationType
    {
