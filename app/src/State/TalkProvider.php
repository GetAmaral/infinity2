 ...
 * Delegates to TalkRepository for all query logic.
 *
 ...
 */
class TalkProvider implements ProviderInterface
{
    ...
    /**
     * Provide collection of Talk entities
     *
     * Uses TalkRepository::apiSearch() for:
     ...
     * @return array<Talk> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Talk entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Talk|null
     */
    private function provideItem(array $uriVariables): ?Talk
    {
