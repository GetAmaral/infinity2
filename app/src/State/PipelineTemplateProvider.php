...
/**
 * PipelineTemplate State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to PipelineTemplateRepository for all query logic.
 *
 ...
 */
class PipelineTemplateProvider implements ProviderInterface
{
    public function __construct(
        private readonly PipelineTemplateRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/pipelinetemplates
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/pipelinetemplates/{id}
    ...
    /**
     * Provide collection of PipelineTemplate entities
     *
     * Uses PipelineTemplateRepository::apiSearch() for:
     ...
     * @return array<PipelineTemplate> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single PipelineTemplate entity
     *
     * @param array<string, mixed> $uriVariables
     * @return PipelineTemplate|null
     */
    private function provideItem(array $uriVariables): ?PipelineTemplate
    {
