...
/**
 * EventResourceBooking State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to EventResourceBookingRepository for all query logic.
 *
 ...
 */
class EventResourceBookingProvider implements ProviderInterface
{
    public function __construct(
        private readonly EventResourceBookingRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/eventresourcebookings
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/eventresourcebookings/{id}
    ...
    /**
     * Provide collection of EventResourceBooking entities
     *
     * Uses EventResourceBookingRepository::apiSearch() for:
     ...
     * @return array<EventResourceBooking> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single EventResourceBooking entity
     *
     * @param array<string, mixed> $uriVariables
     * @return EventResourceBooking|null
     */
    private function provideItem(array $uriVariables): ?EventResourceBooking
    {
