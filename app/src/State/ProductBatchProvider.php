...
/**
 * ProductBatch State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to ProductBatchRepository for all query logic.
 *
 ...
 */
class ProductBatchProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/productbatchs
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/productbatchs/{id}
    ...
    /**
     * Provide collection of ProductBatch entities
     *
     * Uses ProductBatchRepository::apiSearch() for:
     ...
     * @return array<ProductBatch> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single ProductBatch entity
     *
     * @param array<string, mixed> $uriVariables
     * @return ProductBatch|null
     */
    private function provideItem(array $uriVariables): ?ProductBatch
    {
