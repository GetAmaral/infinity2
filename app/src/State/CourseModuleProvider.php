...
/**
 * CourseModule State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to CourseModuleRepository for all query logic.
 *
 ...
 */
class CourseModuleProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/coursemodules
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/coursemodules/{id}
    ...
    /**
     * Provide collection of CourseModule entities
     *
     * Uses CourseModuleRepository::apiSearch() for:
     ...
     * @return array<CourseModule> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single CourseModule entity
     *
     * @param array<string, mixed> $uriVariables
     * @return CourseModule|null
     */
    private function provideItem(array $uriVariables): ?CourseModule
    {
