...
/**
 * TreeFlow State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to TreeFlowRepository for all query logic.
 *
 ...
 */
class TreeFlowProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/treeflows
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/treeflows/{id}
    ...
    /**
     * Provide collection of TreeFlow entities
     *
     * Uses TreeFlowRepository::apiSearch() for:
     ...
     * @return array<TreeFlow> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single TreeFlow entity
     *
     * @param array<string, mixed> $uriVariables
     * @return TreeFlow|null
     */
    private function provideItem(array $uriVariables): ?TreeFlow
    {
