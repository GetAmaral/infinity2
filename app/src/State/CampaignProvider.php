 ...
 * Delegates to CampaignRepository for all query logic.
 *
 ...
 */
class CampaignProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/campaigns
    ...
    /**
     * Provide collection of Campaign entities
     *
     * Uses CampaignRepository::apiSearch() for:
     ...
     * @return array<Campaign> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Campaign entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Campaign|null
     */
    private function provideItem(array $uriVariables): ?Campaign
    {
