...
/**
 * SocialMedia State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to SocialMediaRepository for all query logic.
 *
 ...
 */
class SocialMediaProvider implements ProviderInterface
{
    public function __construct(
        private readonly SocialMediaRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/socialmedias
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/socialmedias/{id}
    ...
    /**
     * Provide collection of SocialMedia entities
     *
     * Uses SocialMediaRepository::apiSearch() for:
     ...
     * @return array<SocialMedia> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single SocialMedia entity
     *
     * @param array<string, mixed> $uriVariables
     * @return SocialMedia|null
     */
    private function provideItem(array $uriVariables): ?SocialMedia
    {
