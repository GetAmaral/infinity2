...
/**
 * EventAttendee State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to EventAttendeeRepository for all query logic.
 *
 ...
 */
class EventAttendeeProvider implements ProviderInterface
{
    public function __construct(
        private readonly EventAttendeeRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/eventattendees
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/eventattendees/{id}
    ...
    /**
     * Provide collection of EventAttendee entities
     *
     * Uses EventAttendeeRepository::apiSearch() for:
     ...
     * @return array<EventAttendee> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single EventAttendee entity
     *
     * @param array<string, mixed> $uriVariables
     * @return EventAttendee|null
     */
    private function provideItem(array $uriVariables): ?EventAttendee
    {
