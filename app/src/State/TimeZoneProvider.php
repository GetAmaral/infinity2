 ...
 * Delegates to TimeZoneRepository for all query logic.
 *
 ...
 */
class TimeZoneProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/timezones
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/timezones/{id}
    ...
    /**
     * Provide collection of TimeZone entities
     *
     * Uses TimeZoneRepository::apiSearch() for:
     ...
     * @return array<TimeZone> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single TimeZone entity
     *
     * @param array<string, mixed> $uriVariables
     * @return TimeZone|null
     */
    private function provideItem(array $uriVariables): ?TimeZone
    {
