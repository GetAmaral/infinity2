...
/**
 * BillingFrequency State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to BillingFrequencyRepository for all query logic.
 *
 ...
 */
class BillingFrequencyProvider implements ProviderInterface
{
    public function __construct(
        private readonly BillingFrequencyRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/billingfrequencys
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/billingfrequencys/{id}
    ...
    /**
     * Provide collection of BillingFrequency entities
     *
     * Uses BillingFrequencyRepository::apiSearch() for:
     ...
     * @return array<BillingFrequency> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single BillingFrequency entity
     *
     * @param array<string, mixed> $uriVariables
     * @return BillingFrequency|null
     */
    private function provideItem(array $uriVariables): ?BillingFrequency
    {
