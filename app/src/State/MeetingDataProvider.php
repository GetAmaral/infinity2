...
/**
 * MeetingData State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to MeetingDataRepository for all query logic.
 *
 ...
 */
class MeetingDataProvider implements ProviderInterface
{
    public function __construct(
        private readonly MeetingDataRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/meetingdatas
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/meetingdatas/{id}
    ...
    /**
     * Provide collection of MeetingData entities
     *
     * Uses MeetingDataRepository::apiSearch() for:
     ...
     * @return array<MeetingData> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single MeetingData entity
     *
     * @param array<string, mixed> $uriVariables
     * @return MeetingData|null
     */
    private function provideItem(array $uriVariables): ?MeetingData
    {
