...
/**
 * CommunicationMethod State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to CommunicationMethodRepository for all query logic.
 *
 ...
 */
class CommunicationMethodProvider implements ProviderInterface
{
    public function __construct(
        private readonly CommunicationMethodRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/communicationmethods
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/communicationmethods/{id}
    ...
    /**
     * Provide collection of CommunicationMethod entities
     *
     * Uses CommunicationMethodRepository::apiSearch() for:
     ...
     * @return array<CommunicationMethod> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single CommunicationMethod entity
     *
     * @param array<string, mixed> $uriVariables
     * @return CommunicationMethod|null
     */
    private function provideItem(array $uriVariables): ?CommunicationMethod
    {
