 ...
 * Delegates to TaskRepository for all query logic.
 *
...
class TaskProvider implements ProviderInterface
{
    ...
    /**
     * Provide collection of Task entities
     *
     * Uses TaskRepository::apiSearch() for:
     ...
     * @return array<Task> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Task entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Task|null
     */
    private function provideItem(array $uriVariables): ?Task
    {
