...
/**
 * EventResourceType State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to EventResourceTypeRepository for all query logic.
 *
 ...
 */
class EventResourceTypeProvider implements ProviderInterface
{
    public function __construct(
        private readonly EventResourceTypeRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/eventresourcetypes
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/eventresourcetypes/{id}
    ...
    /**
     * Provide collection of EventResourceType entities
     *
     * Uses EventResourceTypeRepository::apiSearch() for:
     ...
     * @return array<EventResourceType> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single EventResourceType entity
     *
     * @param array<string, mixed> $uriVariables
     * @return EventResourceType|null
     */
    private function provideItem(array $uriVariables): ?EventResourceType
    {
