...
/**
 * AuditLog State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to AuditLogRepository for all query logic.
 *
...
class AuditLogProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/auditlogs
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/auditlogs/{id}
    ...
    /**
     * Provide collection of AuditLog entities
     *
     * Uses AuditLogRepository::apiSearch() for:
     ...
     * @return array<AuditLog> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single AuditLog entity
     *
     * @param array<string, mixed> $uriVariables
     * @return AuditLog|null
     */
    private function provideItem(array $uriVariables): ?AuditLog
    {
