 ...
 * Delegates to ProfileRepository for all query logic.
 *
...
class ProfileProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/profiles
    ...
    /**
     * Provide collection of Profile entities
     *
     * Uses ProfileRepository::apiSearch() for:
     ...
     * @return array<Profile> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Profile entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Profile|null
     */
    private function provideItem(array $uriVariables): ?Profile
    {
