...
/**
 * StudentCourse State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to StudentCourseRepository for all query logic.
 *
...
class StudentCourseProvider implements ProviderInterface
{
    public function __construct(
        private readonly StudentCourseRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/studentcourses
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/studentcourses/{id}
    ...
    /**
     * Provide collection of StudentCourse entities
     *
     * Uses StudentCourseRepository::apiSearch() for:
     ...
     * @return array<StudentCourse> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single StudentCourse entity
     *
     * @param array<string, mixed> $uriVariables
     * @return StudentCourse|null
     */
    private function provideItem(array $uriVariables): ?StudentCourse
    {
