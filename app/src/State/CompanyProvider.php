 ...
 * Delegates to CompanyRepository for all query logic.
 *
...
class CompanyProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/companys
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/companys/{id}
    ...
    /**
     * Provide collection of Company entities
     *
     * Uses CompanyRepository::apiSearch() for:
     ...
     * @return array<Company> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Company entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Company|null
     */
    private function provideItem(array $uriVariables): ?Company
    {
