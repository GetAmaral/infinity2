...
/**
 * LeadSource State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to LeadSourceRepository for all query logic.
 *
 ...
 */
class LeadSourceProvider implements ProviderInterface
{
    public function __construct(
        private readonly LeadSourceRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/leadsources
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/leadsources/{id}
    ...
    /**
     * Provide collection of LeadSource entities
     *
     * Uses LeadSourceRepository::apiSearch() for:
     ...
     * @return array<LeadSource> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single LeadSource entity
     *
     * @param array<string, mixed> $uriVariables
     * @return LeadSource|null
     */
    private function provideItem(array $uriVariables): ?LeadSource
    {
