...
/**
 * EventResource State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to EventResourceRepository for all query logic.
 *
 ...
 */
class EventResourceProvider implements ProviderInterface
{
    public function __construct(
        private readonly EventResourceRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/eventresources
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/eventresources/{id}
    ...
    /**
     * Provide collection of EventResource entities
     *
     * Uses EventResourceRepository::apiSearch() for:
     ...
     * @return array<EventResource> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single EventResource entity
     *
     * @param array<string, mixed> $uriVariables
     * @return EventResource|null
     */
    private function provideItem(array $uriVariables): ?EventResource
    {
