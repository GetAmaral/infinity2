...
/**
 * DealStage State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to DealStageRepository for all query logic.
 *
 ...
 */
class DealStageProvider implements ProviderInterface
{
    public function __construct(
        private readonly DealStageRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/dealstages
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/dealstages/{id}
    ...
    /**
     * Provide collection of DealStage entities
     *
     * Uses DealStageRepository::apiSearch() for:
     ...
     * @return array<DealStage> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single DealStage entity
     *
     * @param array<string, mixed> $uriVariables
     * @return DealStage|null
     */
    private function provideItem(array $uriVariables): ?DealStage
    {
