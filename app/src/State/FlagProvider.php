 ...
 * Delegates to FlagRepository for all query logic.
 *
 ...
 */
class FlagProvider implements ProviderInterface
{
    public function __construct(
        private readonly FlagRepository $repository
    ) {}
    ...
    /**
     * Provide collection of Flag entities
     *
     * Uses FlagRepository::apiSearch() for:
     ...
     * @return array<Flag> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Flag entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Flag|null
     */
    private function provideItem(array $uriVariables): ?Flag
    {
