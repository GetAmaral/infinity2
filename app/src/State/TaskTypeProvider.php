...
/**
 * TaskType State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to TaskTypeRepository for all query logic.
 *
 ...
 */
class TaskTypeProvider implements ProviderInterface
{
    public function __construct(
        private readonly TaskTypeRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/tasktypes
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/tasktypes/{id}
    ...
    /**
     * Provide collection of TaskType entities
     *
     * Uses TaskTypeRepository::apiSearch() for:
     ...
     * @return array<TaskType> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single TaskType entity
     *
     * @param array<string, mixed> $uriVariables
     * @return TaskType|null
     */
    private function provideItem(array $uriVariables): ?TaskType
    {
