...
/**
 * Brand State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to BrandRepository for all query logic.
 *
...
class BrandProvider implements ProviderInterface
{
    ...
    /**
     * Provide collection of Brand entities
     *
     * Uses BrandRepository::apiSearch() for:
     ...
     * @return array<Brand> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Brand entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Brand|null
     */
    private function provideItem(array $uriVariables): ?Brand
    {
