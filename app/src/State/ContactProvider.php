 ...
 * Delegates to ContactRepository for all query logic.
 *
...
class ContactProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/contacts
    ...
    /**
     * Provide collection of Contact entities
     *
     * Uses ContactRepository::apiSearch() for:
     ...
     * @return array<Contact> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Contact entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Contact|null
     */
    private function provideItem(array $uriVariables): ?Contact
    {
