...
class ProfileProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): Profile
    {
        ...
        if (isset($uriVariables['id'])) {
            $entity = $this->entityManager->getRepository(Profile::class)->find($uriVariables['id']);
            if (!$entity) {
