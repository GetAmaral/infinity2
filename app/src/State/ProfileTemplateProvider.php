...
/**
 * ProfileTemplate State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to ProfileTemplateRepository for all query logic.
 *
 ...
 */
class ProfileTemplateProvider implements ProviderInterface
{
    public function __construct(
        private readonly ProfileTemplateRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/profiletemplates
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/profiletemplates/{id}
    ...
    /**
     * Provide collection of ProfileTemplate entities
     *
     * Uses ProfileTemplateRepository::apiSearch() for:
     ...
     * @return array<ProfileTemplate> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single ProfileTemplate entity
     *
     * @param array<string, mixed> $uriVariables
     * @return ProfileTemplate|null
     */
    private function provideItem(array $uriVariables): ?ProfileTemplate
    {
