 ...
 * Delegates to EventRepository for all query logic.
 *
...
class EventProvider implements ProviderInterface
{
    ...
    /**
     * Provide collection of Event entities
     *
     * Uses EventRepository::apiSearch() for:
     ...
     * @return array<Event> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Event entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Event|null
     */
    private function provideItem(array $uriVariables): ?Event
    {
