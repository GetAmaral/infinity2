...
/**
 * Course State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to CourseRepository for all query logic.
 *
...
class CourseProvider implements ProviderInterface
{
    ...
    /**
     * Provide collection of Course entities
     *
     * Uses CourseRepository::apiSearch() for:
     ...
     * @return array<Course> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Course entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Course|null
     */
    private function provideItem(array $uriVariables): ?Course
    {
