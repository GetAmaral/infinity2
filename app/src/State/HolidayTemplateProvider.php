...
/**
 * HolidayTemplate State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to HolidayTemplateRepository for all query logic.
 *
 ...
 */
class HolidayTemplateProvider implements ProviderInterface
{
    public function __construct(
        private readonly HolidayTemplateRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/holidaytemplates
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/holidaytemplates/{id}
    ...
    /**
     * Provide collection of HolidayTemplate entities
     *
     * Uses HolidayTemplateRepository::apiSearch() for:
     ...
     * @return array<HolidayTemplate> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single HolidayTemplate entity
     *
     * @param array<string, mixed> $uriVariables
     * @return HolidayTemplate|null
     */
    private function provideItem(array $uriVariables): ?HolidayTemplate
    {
