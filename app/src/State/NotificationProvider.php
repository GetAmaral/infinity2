 ...
 * Delegates to NotificationRepository for all query logic.
 *
...
class NotificationProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/notifications
    ...
    /**
     * Provide collection of Notification entities
     *
     * Uses NotificationRepository::apiSearch() for:
     ...
     * @return array<Notification> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Notification entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Notification|null
     */
    private function provideItem(array $uriVariables): ?Notification
    {
