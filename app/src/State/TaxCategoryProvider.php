...
/**
 * TaxCategory State Provider
 *
 * Handles data retrieval for GET and GetCollection operations.
 * Delegates to TaxCategoryRepository for all query logic.
 *
 ...
 */
class TaxCategoryProvider implements ProviderInterface
{
    public function __construct(
        private readonly TaxCategoryRepository $repository
    ) {}
    ...
    public function provide(
        ...
        // GetCollection: GET /api/taxcategorys
        if ($operation instanceof \ApiPlatform\Metadata\GetCollection) {
            return $this->provideCollection($context);
        }

        // Get: GET /api/taxcategorys/{id}
    ...
    /**
     * Provide collection of TaxCategory entities
     *
     * Uses TaxCategoryRepository::apiSearch() for:
     ...
     * @return array<TaxCategory> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single TaxCategory entity
     *
     * @param array<string, mixed> $uriVariables
     * @return TaxCategory|null
     */
    private function provideItem(array $uriVariables): ?TaxCategory
    {
