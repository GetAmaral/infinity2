 ...
 * Delegates to ReminderRepository for all query logic.
 *
 ...
 */
class ReminderProvider implements ProviderInterface
{
    ...
    public function provide(
        ...
        // GetCollection: GET /api/reminders
    ...
    /**
     * Provide collection of Reminder entities
     *
     * Uses ReminderRepository::apiSearch() for:
     ...
     * @return array<Reminder> Array of entities (API Platform handles pagination metadata)
     */
    ...
    /**
     * Provide single Reminder entity
     *
     * @param array<string, mixed> $uriVariables
     * @return Reminder|null
     */
    private function provideItem(array $uriVariables): ?Reminder
    {
