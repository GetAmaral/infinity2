...
/**
 * SocialMediaType State Processor
 *
 ...
 */
class SocialMediaTypeProcessor implements ProcessorInterface
{
    ...
    /**
     * @param SocialMediaTypeInputDto $data
     */
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): SocialMediaType
    {
        if (!$data instanceof SocialMediaTypeInputDto) {
        ...
        if ($isUpdate) {
            $entity = $this->entityManager->getRepository(SocialMediaType::class)->find($uriVariables['id']);
            if (!$entity) {
                throw new BadRequestHttpException('SocialMediaType not found');
            }
        }
