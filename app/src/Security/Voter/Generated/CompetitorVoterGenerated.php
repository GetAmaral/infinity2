...
/**
 * Competitor Voter (Generated Base Class)
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom authorization logic to CompetitorVoter.php instead.
 *
 * @generated by Genmax Code Generator
 */
abstract class CompetitorVoterGenerated extends Voter
{
    ...
    public const LIST = 'COMPETITOR_LIST';
    public const CREATE = 'COMPETITOR_CREATE';
    public const VIEW = 'COMPETITOR_VIEW';
    public const EDIT = 'COMPETITOR_EDIT';
    public const DELETE = 'COMPETITOR_DELETE';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        // For instance-based permissions, subject must be a Competitor
        return $subject instanceof Competitor;
    }
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        return match ($attribute) {
            ...
            self::VIEW => $this->canVIEW($competitor, $user),
            self::EDIT => $this->canEDIT($competitor, $user),
            self::DELETE => $this->canDELETE($competitor, $user),
            default => false,
        };
    }

    /**
     * Check if user can list Competitor     */
    ...
    /**
     * Check if user can create Competitor     */
    ...
    /**
     * Check if user can view Competitor(s)     */
    protected function canVIEW(?Competitor $competitor, User $user): bool
    {
        if (!$competitor) {
            return false;
        }
        ...
        $sameOrganization = $user->getOrganization()
            && $competitor->getOrganization()
            && $user->getOrganization()->getId()->equals($competitor->getOrganization()->getId());
    ...
    /**
     * Check if user can edit Competitor(s)     */
    ...
    /**
     * Check if user can delete Competitor(s)     */
    protected function canDELETE(?Competitor $competitor, User $user): bool
    {
        if (!$competitor) {
            return false;
        }
