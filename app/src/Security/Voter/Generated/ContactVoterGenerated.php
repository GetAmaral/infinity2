...
abstract class ContactVoterGenerated extends Voter
{
    ...
    {
        // Only vote on Contact objects with supported attributes
    ...
    /**
     * Check if user can view the Contact
     */
    protected function canView(Contact $contact, User $user): bool
    {
        // Check if user belongs to the same organization
        if ($contact->getOrganization()->getId() !== $user->getOrganization()->getId()) {
            return false;
        }
    ...
    /**
     * Check if user can delete the Contact
     */
