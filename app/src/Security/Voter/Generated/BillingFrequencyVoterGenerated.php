...
abstract class BillingFrequencyVoterGenerated extends Voter
{
    ...
    public const LIST = 'BILLING_FREQUENCY_LIST';
    public const CREATE = 'BILLING_FREQUENCY_CREATE';
    ...
    /**
     * Check if user can list BillingFrequency     */
    ...
    /**
     * Check if user can create BillingFrequency     */
