...
/**
 * TalkType Voter (Generated Base Class)
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom authorization logic to TalkTypeVoter.php instead.
 *
 * @generated by Genmax Code Generator
 */
abstract class TalkTypeVoterGenerated extends Voter
{
    ...
    public const LIST = 'TALK_TYPE_LIST';
    public const CREATE = 'TALK_TYPE_CREATE';
    public const VIEW = 'TALK_TYPE_VIEW';
    public const EDIT = 'TALK_TYPE_EDIT';
    public const DELETE = 'TALK_TYPE_DELETE';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        // For instance-based permissions, subject must be a TalkType
        return $subject instanceof TalkType;
    }
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        /** @var TalkType|null $talkType */
        $talkType = $subject;

        return match ($attribute) {
            self::LIST => $this->canLIST($user),
            self::CREATE => $this->canCREATE($user),
            self::VIEW => $this->canVIEW($talkType, $user),
            self::EDIT => $this->canEDIT($talkType, $user),
            self::DELETE => $this->canDELETE($talkType, $user),
            default => false,
        };
    }

    /**
     * Check if user can list TalkType     */
    ...
    /**
     * Check if user can create TalkType     */
    ...
    /**
     * Check if user can view TalkType(s)     */
    protected function canVIEW(?TalkType $talkType, User $user): bool
    {
        if (!$talkType) {
            return false;
        }
        ...
        $sameOrganization = $user->getOrganization()
            && $talkType->getOrganization()
            && $user->getOrganization()->getId()->equals($talkType->getOrganization()->getId());
    ...
    /**
     * Check if user can edit TalkType(s)     */
    ...
    /**
     * Check if user can delete TalkType(s)     */
    protected function canDELETE(?TalkType $talkType, User $user): bool
    {
        if (!$talkType) {
            return false;
        }
