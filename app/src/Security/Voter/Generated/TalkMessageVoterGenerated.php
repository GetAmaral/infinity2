...
abstract class TalkMessageVoterGenerated extends Voter
{
    ...
    public const LIST = 'TALK_MESSAGE_LIST';
    public const CREATE = 'TALK_MESSAGE_CREATE';
    public const VIEW = 'TALK_MESSAGE_VIEW';
    public const EDIT = 'TALK_MESSAGE_EDIT';
    public const DELETE = 'TALK_MESSAGE_DELETE';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        // For instance-based permissions, subject must be a TalkMessage
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        /** @var TalkMessage|null $talkMessage */
        $talkMessage = $subject;
    ...
    /**
     * Check if user can list TalkMessage     */
    ...
    /**
     * Check if user can create TalkMessage     */
    ...
    /**
     * Check if user can view TalkMessage(s)     */
    protected function canVIEW(?TalkMessage $talkMessage, User $user): bool
    {
        ...
        $sameOrganization = $user->getOrganization()
            && $talkMessage->getOrganization()
            && $user->getOrganization()->getId()->equals($talkMessage->getOrganization()->getId());
    ...
    /**
     * Check if user can edit TalkMessage(s)     */
    ...
    /**
     * Check if user can delete TalkMessage(s)     */
