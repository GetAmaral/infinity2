...
/**
 * Attachment Voter (Generated Base Class)
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom authorization logic to AttachmentVoter.php instead.
 *
 * @generated by Genmax Code Generator
 */
abstract class AttachmentVoterGenerated extends Voter
{
    ...
    public const LIST = 'ATTACHMENT_LIST';
    public const CREATE = 'ATTACHMENT_CREATE';
    public const VIEW = 'ATTACHMENT_VIEW';
    public const EDIT = 'ATTACHMENT_EDIT';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        // For instance-based permissions, subject must be a Attachment
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        return match ($attribute) {
            ...
            self::VIEW => $this->canVIEW($attachment, $user),
            self::EDIT => $this->canEDIT($attachment, $user),
            self::DELETE => $this->canDELETE($attachment, $user),
            default => false,
        };
    }

    /**
     * Check if user can list Attachment     */
    ...
    /**
     * Check if user can view Attachment(s)     */
    protected function canVIEW(?Attachment $attachment, User $user): bool
    {
        if (!$attachment) {
            return false;
        }
        ...
        $sameOrganization = $user->getOrganization()
            && $attachment->getOrganization()
            && $user->getOrganization()->getId()->equals($attachment->getOrganization()->getId());
    ...
    /**
     * Check if user can edit Attachment(s)     */
    ...
    /**
     * Check if user can delete Attachment(s)     */
    protected function canDELETE(?Attachment $attachment, User $user): bool
    {
        if (!$attachment) {
            return false;
        }
