...
abstract class LeadSourceVoterGenerated extends Voter
{
    ...
    {
        // Only vote on LeadSource objects with supported attributes
        if (!in_array($attribute, ['VIEW', 'EDIT', 'DELETE'], true)) {
            return false;
        }

        if (!$subject instanceof LeadSource) {
            return false;
        }
    ...
    /**
     * Check if user can view the LeadSource
     */
    protected function canView(LeadSource $leadsource, User $user): bool
    {
        // Check if user belongs to the same organization
        if ($leadsource->getOrganization()->getId() !== $user->getOrganization()->getId()) {
            return false;
        }
    ...
    /**
     * Check if user can edit the LeadSource
     */
    ...
    /**
     * Check if user can delete the LeadSource
     */
