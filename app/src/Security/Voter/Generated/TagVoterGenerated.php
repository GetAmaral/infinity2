...
abstract class TagVoterGenerated extends Voter
{
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        // For instance-based permissions, subject must be a Tag
    ...
    protected function canVIEW(?Tag $tag, User $user): bool
    {
        ...
        $sameOrganization = $user->getOrganization()
            && $tag->getOrganization()
            && $user->getOrganization()->getId()->equals($tag->getOrganization()->getId());
    ...
    /**
     * Check if user can delete Tag(s)     */
