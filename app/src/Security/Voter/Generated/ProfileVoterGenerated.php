...
/**
 * Profile Voter (Generated Base Class)
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom authorization logic to ProfileVoter.php instead.
 *
 * @generated by Genmax Code Generator
 */
abstract class ProfileVoterGenerated extends Voter
{
    ...
    public const LIST = 'PROFILE_LIST';
    public const CREATE = 'PROFILE_CREATE';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        // For instance-based permissions, subject must be a Profile
    ...
    /**
     * Check if user can list Profile     */
    ...
    /**
     * Check if user can view Profile(s)     */
    protected function canVIEW(?Profile $profile, User $user): bool
    {
        ...
        $sameOrganization = $user->getOrganization()
            ...
            && $user->getOrganization()->getId()->equals($profile->getOrganization()->getId());
    ...
    /**
     * Check if user can edit Profile(s)     */
    ...
    /**
     * Check if user can delete Profile(s)     */
