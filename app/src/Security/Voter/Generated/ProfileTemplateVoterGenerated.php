...
/**
 * ProfileTemplate Voter (Generated Base Class)
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom authorization logic to ProfileTemplateVoter.php instead.
 *
 * @generated by Genmax Code Generator
 */
abstract class ProfileTemplateVoterGenerated extends Voter
{
    ...
    public const LIST = 'PROFILE_TEMPLATE_LIST';
    public const CREATE = 'PROFILE_TEMPLATE_CREATE';
    public const VIEW = 'PROFILE_TEMPLATE_VIEW';
    public const EDIT = 'PROFILE_TEMPLATE_EDIT';
    public const DELETE = 'PROFILE_TEMPLATE_DELETE';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        // For instance-based permissions, subject must be a ProfileTemplate
        return $subject instanceof ProfileTemplate;
    }
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        /** @var ProfileTemplate|null $profileTemplate */
        $profileTemplate = $subject;

        return match ($attribute) {
            self::LIST => $this->canLIST($user),
            self::CREATE => $this->canCREATE($user),
            self::VIEW => $this->canVIEW($profileTemplate, $user),
            self::EDIT => $this->canEDIT($profileTemplate, $user),
            self::DELETE => $this->canDELETE($profileTemplate, $user),
            default => false,
        };
    }

    /**
     * Check if user can list ProfileTemplate     */
    ...
    /**
     * Check if user can create ProfileTemplate     */
    ...
    /**
     * Check if user can view ProfileTemplate(s)     */
    ...
    /**
     * Check if user can edit ProfileTemplate(s)     */
    ...
    /**
     * Check if user can delete ProfileTemplate(s)     */
