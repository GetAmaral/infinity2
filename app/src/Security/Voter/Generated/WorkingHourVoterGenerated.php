...
abstract class WorkingHourVoterGenerated extends Voter
{
    ...
    public const LIST = 'WORKING_HOUR_LIST';
    public const CREATE = 'WORKING_HOUR_CREATE';
    public const VIEW = 'WORKING_HOUR_VIEW';
    public const EDIT = 'WORKING_HOUR_EDIT';
    public const DELETE = 'WORKING_HOUR_DELETE';
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        // For instance-based permissions, subject must be a WorkingHour
        return $subject instanceof WorkingHour;
    }
    ...
    /**
     * Check if user can list WorkingHour     */
    ...
    /**
     * Check if user can create WorkingHour     */
    ...
    /**
     * Check if user can view WorkingHour(s)     */
    protected function canVIEW(?WorkingHour $workingHour, User $user): bool
    {
        ...
        $sameOrganization = $user->getOrganization()
            && $workingHour->getOrganization()
            && $user->getOrganization()->getId()->equals($workingHour->getOrganization()->getId());
    ...
    /**
     * Check if user can edit WorkingHour(s)     */
    ...
    /**
     * Check if user can delete WorkingHour(s)     */
