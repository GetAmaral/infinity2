...
/**
 * ProductLineRepository (Generated Base Class)
 *
 * Product lines for business organization
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom query methods to ProductLineRepository.php instead.
 *
 * Provides:
 ...
 *
 * @extends BaseRepository<ProductLine>
 * @generated by Genmax Code Generator
 */
abstract class ProductLineRepositoryGenerated extends BaseRepository
{
    /**
    ...
    {
        return [            'name' => 'name',            'description' => 'description',            'active' => 'active',            'products' => 'products',            'createdAt' => 'createdAt',            'updatedAt' => 'updatedAt',        ];
    }
    ...
    /**
     * Transform ProductLine entity to array for API response
    ...
    {
        assert($entity instanceof ProductLine);
