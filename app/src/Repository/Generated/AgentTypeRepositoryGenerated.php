...
/**
 * AgentTypeRepository (Generated Base Class)
 *
 * Agent types for customer support and sales teams
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom query methods to AgentTypeRepository.php instead.
 *
 * Provides:
 ...
 *
 * @extends BaseRepository<AgentType>
 * @generated by Genmax Code Generator
 */
abstract class AgentTypeRepositoryGenerated extends BaseRepository
{
    /**
    ...
    {
        return [            'name',            'description',            'code',            'color',            'defaultPrompt',            'icon',        ];
    }
    ...
    {
        return [            'name' => 'name',            'description' => 'description',            'active' => 'active',            'code' => 'code',            'color' => 'color',            'default' => 'default',            'defaultPrompt' => 'defaultPrompt',            'icon' => 'icon',            'sortOrder' => 'sortOrder',            'createdAt' => 'createdAt',            'updatedAt' => 'updatedAt',        ];
    }
    ...
    /**
     * Transform AgentType entity to array for API response
    ...
    {
        assert($entity instanceof AgentType);
