...
/**
 * LeadSourceRepository (Generated Base Class)
 *
 * Lead sources for multi-touch attribution tracking and ROI analysis
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom query methods to LeadSourceRepository.php instead.
 *
 * Provides:
 ...
 *
 * @extends BaseRepository<LeadSource>
 * @generated by Genmax Code Generator
 */
abstract class LeadSourceRepositoryGenerated extends BaseRepository
{
    /**
    ...
    {
        return [            'name' => 'name',            'description' => 'description',            'category' => 'category',            'active' => 'active',            'deals' => 'deals',            'createdAt' => 'createdAt',            'updatedAt' => 'updatedAt',        ];
    }
    ...
    /**
     * Transform LeadSource entity to array for API response
    ...
    {
        assert($entity instanceof LeadSource);
