...
/**
 * EventResourceTypeRepository (Generated Base Class)
 *
 * Types of event resources (Meeting Room, Equipment, Vehicle, etc.)
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom query methods to EventResourceTypeRepository.php instead.
 *
 * Provides:
 ...
 *
 * @extends BaseRepository<EventResourceType>
 * @generated by Genmax Code Generator
 */
abstract class EventResourceTypeRepositoryGenerated extends BaseRepository
{
    /**
    ...
    {
        return [            'name' => 'name',            'description' => 'description',            'organization' => 'organization',            'createdAt' => 'createdAt',            'updatedAt' => 'updatedAt',        ];
    }
    ...
    /**
     * Transform EventResourceType entity to array for API response
    ...
    {
        assert($entity instanceof EventResourceType);
