...
/**
 * TaskTypeRepository (Generated Base Class)
 *
 * Task types for categorization (Call, Email, Meeting, etc.)
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom query methods to TaskTypeRepository.php instead.
 *
 * Provides:
 ...
 *
 * @extends BaseRepository<TaskType>
 * @generated by Genmax Code Generator
 */
abstract class TaskTypeRepositoryGenerated extends BaseRepository
{
    /**
    ...
    {
        return [            'name' => 'name',            'taskFunction' => 'taskFunction',            'taskTemplates' => 'taskTemplates',            'tasks' => 'tasks',            'createdAt' => 'createdAt',            'updatedAt' => 'updatedAt',        ];
    }
    ...
    /**
     * Transform TaskType entity to array for API response
    ...
    {
        assert($entity instanceof TaskType);
