...
/**
 * SocialMediaTypeRepository (Generated Base Class)
 *
 * Social media platform types (Facebook, LinkedIn, Twitter, etc.)
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom query methods to SocialMediaTypeRepository.php instead.
 *
 * Provides:
 ...
 *
 * @extends BaseRepository<SocialMediaType>
 * @generated by Genmax Code Generator
 */
abstract class SocialMediaTypeRepositoryGenerated extends BaseRepository
{
    /**
    ...
    {
        return [            'name' => 'name',            'iconUrl' => 'iconUrl',            'url' => 'url',            'createdAt' => 'createdAt',            'updatedAt' => 'updatedAt',        ];
    }
    ...
    /**
     * Transform SocialMediaType entity to array for API response
    ...
    {
        assert($entity instanceof SocialMediaType);
