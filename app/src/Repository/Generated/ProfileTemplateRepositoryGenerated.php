...
/**
 * ProfileTemplateRepository (Generated Base Class)
 *
 * Templates for user profiles with predefined permissions
 *
 * This class is ALWAYS regenerated. DO NOT edit this file.
 * Add custom query methods to ProfileTemplateRepository.php instead.
 *
 * Provides:
 ...
 *
 * @extends BaseRepository<ProfileTemplate>
 * @generated by Genmax Code Generator
 */
abstract class ProfileTemplateRepositoryGenerated extends BaseRepository
{
    /**
    ...
    {
        return [            'name' => 'name',            'grantedRoles' => 'grantedRoles',            'createdAt' => 'createdAt',            'updatedAt' => 'updatedAt',        ];
    }
    ...
    /**
     * Transform ProfileTemplate entity to array for API response
    ...
    {
        assert($entity instanceof ProfileTemplate);
